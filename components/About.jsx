    ...
    <div className="text-white mt-10 md:mt-40 ">
      ...
      <div className="flex gap-4 mt-4 flex-col md:flex-row md:items-center ">
        ...
        <div>
          ...
          >
            Having worked as a Frontend developer for one years, with a focus on
            React.js and Next.js, I have a solid background in building dynamic
            and responsive online applications. I am currently leading and
            supervising three major projects as a frontend developer at a seeded
            company, showcasing my capacity to effectively manage and complete
            challenging tasks. I have also finished personal projects that
            demonstrate my commitment to lifelong learning and my enthusiasm for
            technology research.
          </motion.p>
        </div>
      </div>
